# 经营归因分析系统 — Agent notes

## Agent skills

### Issue tracker

Issues are tracked in this repo's private GitHub Issues (via `gh`) at `chaosorder010/jing-ying-gui-yin-system`. See `docs/agents/issue-tracker.md`.
